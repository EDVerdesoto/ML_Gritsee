...
INPUT_FOLDER = Path(r"C:\Proyectos\ML_Gritsee\datasets\Img_entrenamiento\Detection_Unique_640")
# Ruta de SALIDA (Se creará en PRACTICAS)
OUTPUT_FOLDER = Path(r"C:\Proyectos\ML_Gritsee\datasets\dataset_yolo_final")
